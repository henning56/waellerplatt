...
class DirectImportSeeder extends Seeder
{
    public function run()
    {
        // Temporäre MySQL-Verbindung konfigurieren
        ...
        try {
            // Daten direkt aus MySQL lesen
            $mysqlData = DB::connection('temp_mysql')->table('dialect_expressions')->get();
